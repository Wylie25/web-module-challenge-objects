...
let stew = createMenuItem("beef stew", 6, "soup");
let eggs = createMenuItem("scrambled eggs", 3, "breakfast");
let fries = createMenuItem("french fries", 7, "lunch");
console.log(eggs);
...
function findFeedback(reviews, name) {
...
console.log(findFeedback(reviews, "Julius"));

/* Task 4: Add a new rating with your (fictitious) opinions of the restaurant in the same format as the reviews above. */
reviews.push({
  name: "Tyler",
  rating: 4,
  feedback: "Lovely place with a great selection of food.",
});
